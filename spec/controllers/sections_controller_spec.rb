  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved section as @section" do
        ...
        post :create, {:section => { "title" => "invalid value" }}, valid_session
        assigns(:section).should be_a_new(Section)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested section" do
        ...
        Section.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => section.to_param, :section => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the section as @section" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Section.any_instance.stub(:save).and_return(false)
        put :update, {:id => section.to_param, :section => { "title" => "invalid value" }}, valid_session
        assigns(:section).should eq(section)
      end
